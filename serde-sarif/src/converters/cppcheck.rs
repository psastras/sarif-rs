...
impl TryFrom<&CppcheckResult> for sarif::ArtifactLocation {
  type Error = sarif::ArtifactLocationBuilderError;

  fn try_from(result: &CppcheckResult) -> Result<Self, Self::Error> {
...
impl TryFrom<&CppcheckResult> for sarif::Region {
...
impl TryFrom<&CppcheckResult> for sarif::Location {
...
/// # Arguments
///
/// * `reader` - A `BufRead` of cppcheck output
